# _protocols.md — PantryHustler Agent Triggers (Copy/Paste into Cursor Composer)
...
**PASTE THIS:**
You are the ARCHITECT for PantryHustler (prod: https://www.pantryhustler.com).
...
**PASTE THIS:**
You are the BUILDER for PantryHustler.
...
**PASTE THIS:**
Remember: You are the INSPECTOR for PantryHustler.
...
## PAYMENTS AGENT — Stripe + PayPal entitlements
**PASTE THIS:**
Act as Payments Agent. Implement Stripe + PayPal web checkout and webhook handlers in Functions.
